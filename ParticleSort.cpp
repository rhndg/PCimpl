...
const GLchar* particle_sort_vert_shader = GLSL(
    ...
    void main(){
        ...
        int my_extended_index       = textureLod(index_arr, decode_particle_index(my_index), 0).r;
        int other_extended_index    = textureLod(index_arr, decode_particle_index(other_index), 0).r;
